...
type LogEntry struct {
	...
	RealIdx uint64 `protobuf:"varint,3,opt,name=real_idx,json=realIdx,proto3" json:"real_idx,omitempty"`
}
...
func (x *LogEntry) GetRealIdx() uint64 {
	if x != nil {
		return x.RealIdx
	}
	return 0
...
type RequestVoteRequest struct {
	...
	LastLogIdx  uint64 `protobuf:"varint,3,opt,name=last_log_idx,json=lastLogIdx,proto3" json:"last_log_idx,omitempty"`
...
type AppendEntriesRequest struct {
	...
	PrevLogIdx      uint64      `protobuf:"varint,3,opt,name=prev_log_idx,json=prevLogIdx,proto3" json:"prev_log_idx,omitempty"`
	PrevLogTerm     int32       `protobuf:"varint,4,opt,name=prev_log_term,json=prevLogTerm,proto3" json:"prev_log_term,omitempty"`
	LeaderCommitIdx uint64      `protobuf:"varint,5,opt,name=leader_commit_idx,json=leaderCommitIdx,proto3" json:"leader_commit_idx,omitempty"`
...
func (x *AppendEntriesRequest) GetPrevLogIdx() uint64 {
	if x != nil {
		return x.PrevLogIdx
	}
	return 0
...
func (x *AppendEntriesRequest) GetLeaderCommitIdx() uint64 {
	if x != nil {
...
var file_proto_v1_cm_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x72, 0x65, 0x61, 0x6c, 0x49,
	...
	0x73, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	...
	0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a,
	...
	0x69, 0x64, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x6c, 0x65, 0x61, 0x64, 0x65,
